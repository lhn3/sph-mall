      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li class="" v-for="nav in floorInfo.navList" :key="nav.text">
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="keyword in floorInfo.keywords" :key="keyword">{{keyword}}</li>
              </ul>
              <img :src="floorInfo.imgUrl" />
            </div>
            <div class="floorBanner">
              <Swiper :banners="floorInfo.carouselList"></Swiper>
            </div>
            <div class="split">
